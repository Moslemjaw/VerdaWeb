...
import { ArrowLeft, ShoppingBag, Heart, Check, Minus, Plus, Share2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-14 sm:pt-16 pb-32">
        ...
        <motion.div 
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="aspect-[3/4] sm:aspect-[4/5] md:aspect-[3/4] lg:aspect-[4/3] max-h-[70vh] w-full overflow-hidden bg-secondary/30"
        >
          <img 
